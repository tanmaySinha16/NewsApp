...
A news app that allows users to access and read the latest news stories and articles. It uses a remote API to access the news and users can also search and save the news. The app uses best practices like MVVM, ROOM, LIVEDATA, COROUTINES, NAVIGATION COMPONENTS, and RETROFIT.
